...
void calibration(){
  ...
  while (1){
    ...
    meansensors();
    Serial.println("...");
    Serial.print(mean_ax); Serial.print(","); Serial.print(mean_ay); Serial.print(","); Serial.print(mean_az); Serial.print(",");
    Serial.print(mean_gx); Serial.print(","); Serial.print(mean_gy); Serial.print(","); Serial.print(mean_gz); Serial.println(",");
